...
@section('content')
    <div id="dashContent">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">{{ __('Lakcím létrehozása') }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="post_code" type="text" class="form-control @error('post_code') is-invalid @enderror"
                                       name="post_code" value="{{old('post_code')}}" required autocomplete="post_code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_name" type="text" class="form-control @error('street_name') is-invalid @enderror"
                                       name="street_name" value="{{old('street_name')}}" required autocomplete="street_name" autofocus>
